...
@section('main')
    ...
    {!! Form::model($maintainrecord, ['method' => 'PATCH', 'action' => ['Sales\MaintainrecordController@update', $maintainrecord->id], 'class' => 'form-horizontal', 'files' => true]) !!}
        @include('sales.maintainrecords._form', ['submitButtonText' => '保存'])
    {!! Form::close() !!}
